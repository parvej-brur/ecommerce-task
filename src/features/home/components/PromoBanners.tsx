      ...
      <div className="grid grid-cols-1 grid-rows-2 gap-3.5 md:grid-cols-[5fr_4fr]">
        ...
        >
          ...
          <Image
            ...
            width={181}
            height={174}
            className="pointer-events-none absolute top-1/2 right-4 h-52 w-52 -translate-y-1/2 object-contain drop-shadow-[0_12px_24px_rgba(0,0,0,0.35)] sm:h-60 sm:w-60 lg:h-68 lg:w-68"
          />
        </Link>
        ...
        <div className="grid grid-cols-2 gap-3.5">
          ...
          >
            <div className="max-w-[65%]">
              ...
              <div className="mb-1 text-lg leading-tight font-extrabold text-[#1e3a5f]">
                Best Deals
              </div>
